...
class Topic(models.Model):
    ...
    board = models.ForeignKey(Board, on_delete=models.PROTECT, related_name='topics')  # related_name = (class_name)_set
    starter = models.ForeignKey(User, on_delete=models.PROTECT, related_name='topics')  #              = topic_set
